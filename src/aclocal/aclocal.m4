...
# Deal with Tcl shared libraries
    ...
    TCL_LIBS="-L$TCL_PREFIX/lib -L$TCL_PREFIX/lib64 -ltcl$TCL_VERSION -ltclstub$TCL_VERSION"
    TK_LIBS="-L$TK_PREFIX/lib -L$TK_PREFIX/lib64 -ltk$TCL_VERSION -ltkstub$TCL_VERSION"
    AC_SUBST([TK_LIBS])
    AC_SUBST([TCL_LIBS])
  fi
])
